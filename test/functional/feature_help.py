...
"""Verify that starting Apecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Apecoin with -h for help text")
        ...
        self.log.info("Start Apecoin with -version for version information")
        ...
        self.log.info("Start Apecoind with -fakearg to make sure it does not start")
