...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.Apecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.Apecointools.com");
        vSeeds.emplace_back("dnsseed.Apecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.Apecointools.com");
        vSeeds.emplace_back("seed-b.Apecoin.loshan.co.uk");
