Apecoin Core version *0.15.1* is now available from:

  <https://download.Apecoin.org/Apecoin-0.15.1/>
...
A number of changes to the way Apecoin Core deals with peer connections and invalid blocks
