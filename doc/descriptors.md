# Support for Output Descriptors in Apecoin Core

Since Apecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Apecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Apecoin Core wallets, a convenience function `combo` is
